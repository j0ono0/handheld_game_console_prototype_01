...
const Sprite sprite_prof_walk_north = {2, sprite_frameset_prof_walk_north};
const Sprite sprite_prof_walk_east = {2, sprite_frameset_prof_walk_east};
const Sprite sprite_prof_walk_south = {2, sprite_frameset_prof_walk_south};
const Sprite sprite_prof_walk_west = {2, sprite_frameset_prof_walk_west};
const Sprite sprite_prof_stationary_west = {1, sprite_frameset_prof_stationary_west };
const Sprite sprite_prof_stationary_east = {1, sprite_frameset_prof_stationary_east };
...
const Sprite sprite_strongman = {1, sprite_frameset_strongman};
const Sprite sprite_office_chair = {1, sprite_frameset_office_chair};
const Sprite sprite_desktop_panel = {1, sprite_frameset_desktop_panel};
const Sprite sprite_desktop_terminal = {1, sprite_frameset_desktop_terminal};
const Sprite sprite_inbuilt_terminal = {1, sprite_frameset_inbuilt_terminal};
const Sprite sprite_desktop_clutter = {1, sprite_frameset_desktop_clutter};