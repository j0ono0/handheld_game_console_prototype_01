...
extern const Sprite *sprite_prof_walk_east_cycle[];
extern const Sprite *sprite_prof_walk_west_cycle[];
extern const Sprite *sprite_prof_walk_north_cycle[];
extern const Sprite *sprite_prof_walk_south_cycle[];
